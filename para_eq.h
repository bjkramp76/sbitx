...
/*
 * FM MODE SUPPORT:
 * When using FM mode, the parametric EQ may be used to shape the audio signal,
 * for example by applying pre-emphasis or de-emphasis filtering as needed.
 * The equalizer settings can be adjusted to meet the audio processing requirements
 * specific to FM modulation.
 */
