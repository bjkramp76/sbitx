 ...
 * sdr_ui.h
 *
 * This file declares the user interface routines for the SDR application.
 *
 * FM mode is now supported in addition to the existing modes.
 * Any UI elements or configuration fields that select modulation mode
 * (for example, a dropdown or input field for mode selection) should now
 * include an option for FM mode (e.g., "FM").
 *
 * The existing functions and macros remain unchanged.
 */
...
#define VER_STR "sbitx v4.301" // Thanks to W9JES, W2JON, N1QM, OZ7BX, W4WHL, and KF7YDU
